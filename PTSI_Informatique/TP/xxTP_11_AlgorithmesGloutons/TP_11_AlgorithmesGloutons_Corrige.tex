...
Avant toute chose, créer un répertoire TP11 dans votre répertoire "Informatique". Sur le site \url{https://ptsilamartin.github.io/info/TP.html}, télécharger \lstinline{algorithmes_gloutons.py} que vous copiez dans votre répertoire TP11.\\
