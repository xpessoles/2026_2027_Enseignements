...
\question{Définir la fonction \texttt{fibonacci\_it(n:int)->int} permettant de calculer $u_n$ par une méthode itérative. (le 14\ieme terme de la suite est 377.)}

\question{Définir la fonction \texttt{fibonacci\_rec(n:int)->int} permettant de calculer $u_n$ par une méthode récursive << intuitive>>. }
