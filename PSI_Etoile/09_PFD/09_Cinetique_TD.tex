...
% "{'classe':('PSI'),'chapitre':'dyn_pfd','type':('cours'),'titre':'Application du Principe Fondamental de la Dynamique', 'source':' ','comp':('B2-10','DYN-04'),'corrige':True}"
