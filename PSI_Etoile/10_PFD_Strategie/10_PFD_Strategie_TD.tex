...
%  \KOMAoptions{toc=flat}% empêche kaobook d'utiliser chapter*
%  \section*{\contentsname}% titre comme section
%  \etocsettocstyle{}{}% style du TOC
%  \etocfullcontents% affiche le TOC
%}
%\makeatother
